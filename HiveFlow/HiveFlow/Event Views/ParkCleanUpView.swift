...
struct ParkCleanUpView_Previews: PreviewProvider {
    static var previews: some View {
        var actionViewModel = ActionViewModel()
        ParkCleanUpView(viewModel: actionViewModel)
    }
}
